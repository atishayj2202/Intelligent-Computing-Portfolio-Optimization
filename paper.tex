...
We introduce AOBL-SOS (Adaptive Opposition-Based Learning enhanced Symbiotic Organisms Search). This framework evaluates the historical return path to explicitly penalize maximum drawdown, introducing a novel objective function that maximizes the risk-adjusted return ratio normalized by tail risk. Evaluated over a 179-asset S\&P 500 universe from 2012 to 2025—net of 10 basis points transaction costs at monthly rebalancing—the framework achieves an out-of-sample net annualized return of 5.12\% and a net Sharpe ratio of 0.198, systematically outperforming standard SOS (0.039) and Markowitz maximum Sharpe portfolios (0.121). The resulting allocation process provides practitioners with a robust, computationally feasible mechanism for avoiding local risk optima during market regime shifts.
\end{abstract}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{results/cumulative_net_returns.png}
...
\midrule
2012-2017 $\rightarrow$ 2018 & \textbf{2.45} & 1.88 & 2.11 & 3.11 & 2.70 \\
2012-2018 $\rightarrow$ 2019 & \textbf{1.81} & 1.44 & 1.79 & 2.20 & 1.97 \\
2012-2019 $\rightarrow$ 2020 (COVID) & \textbf{0.11} & --0.15 & 0.46 & 0.48 & 0.72 \\
2012-2020 $\rightarrow$ 2021 & \textbf{0.05} & --0.18 & --0.06 & --0.16 & 0.09 \\
2012-2021 $\rightarrow$ 2022 (Hikes) & \textbf{1.24} & 0.81 & 0.58 & 1.22 & 1.38 \\
2012-2022 $\rightarrow$ 2023-2025 & \textbf{0.92} & 0.55 & 0.81 & 0.46 & 0.71 \\
\bottomrule
\end{tabular}
}
\end{table*}

Table \ref{tab:walk_forward} tests the strategy out-of-sample over continuous expanding windows to rule out regime overfitting. AOBL-SOS demonstrates severe performance resilience during the 2020 liquidity crisis and the 2022 global inflation cycle, maintaining positive net Sharpe ratios across major drawdowns where Markowitz solvers collapsed into negative values.
...
\bibitem{ledoit2004} Ledoit, O., \& Wolf, M. (2004). A well-conditioned estimator for large-dimensional covariance matrices. \textit{Journal of Multivariate Analysis}, 88(2), 365--411.
\bibitem{chang2000} Chang, T. J., et al. (2000). Heuristics for cardinality constrained portfolio optimisation. \textit{Computers \& Operations Research}, 27(13), 1271--1302.
\bibitem{cheng2014} Cheng, M. Y., \& Prayogo, D. (2014). Symbiotic Organisms Search. \textit{Computers \& Structures}, 139, 98--112.
\bibitem{fabozzi2007} Fabozzi, F. J., et al. (2007). \textit{Robust Portfolio Optimization and Management}. John Wiley \& Sons.
\bibitem{tizhoosh2005} Tizhoosh, H. R. (2005). Opposition-based learning: A new scheme for machine intelligence. \textit{CIMCA}, 695--701.
\end{thebibliography}
