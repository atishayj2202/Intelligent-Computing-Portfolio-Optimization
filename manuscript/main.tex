...
\midrule
2018 (Pre-COVID Bull) & \textbf{1.94} & 1.20 & 0.74 & 1.68 & 0.91 \\
2019 (Late-Cycle Expansion) & \textbf{1.58} & 0.88 & 0.98 & 0.87 & 1.36 \\
2020 (COVID Crash \& Recovery) & \textbf{2.50} & 1.81 & 0.54 & 1.89 & 1.36 \\
2021 (Post-COVID Rally) & \textbf{1.82} & 1.26 & 1.44 & 0.08 & 1.76 \\
2022 (Rate Hike Drawdown) & \textbf{2.45} & 2.25 & 0.98 & 0.90 & 1.15 \\
...
Table \ref{tab:walk_forward} and Figure \ref{fig:walk_forward_chart} test the deterministically optimized strategy out-of-sample across distinct macroeconomic regimes to rule out regime overfitting \cite{bailey2014, deprado2018}. AOBL-SOS demonstrates absolute dominance across all market cycles, maintaining the highest net Sharpe ratios during both the 2020 liquidity crisis and the 2022 global inflation cycle, where traditional Markowitz solvers experienced severe degradation.
