...
\midrule
2012-2017 $\rightarrow$ 2018 & 0.40 & 1.62 & \textbf{2.15} & 1.90 & 0.91 \\
2012-2018 $\rightarrow$ 2019 & 0.85 & 1.97 & \textbf{2.38} & 0.33 & 1.36 \\
2012-2019 $\rightarrow$ 2020 (COVID) & 1.25 & 1.34 & \textbf{1.68} & 1.06 & 1.36 \\
2012-2020 $\rightarrow$ 2021 & \textbf{1.30} & 1.76 & 0.86 & 2.11 & 1.76 \\
2012-2021 $\rightarrow$ 2022 (Hikes) & 1.32 & 0.56 & \textbf{1.69} & 1.04 & 1.15 \\
2012-2022 $\rightarrow$ 2023-2025 & \textbf{1.06} & 0.91 & 0.70 & 0.76 & 1.21 \\
\bottomrule
\end{tabular}
}
\end{table}
...
Table \ref{tab:walk_forward} and Figure \ref{fig:walk_forward_chart} test the strategy out-of-sample over continuous expanding windows to rule out regime overfitting \cite{bailey2014, deprado2018}. AOBL-SOS maintains consistently positive net Sharpe ratios across all six windows, including the 2020 COVID crash and the 2022 rate-hiking cycle, where Markowitz collapsed to a Sharpe of 0.56.
